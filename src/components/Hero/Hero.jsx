...
export default function Hero() {
  ...
  useEffect(() => {
    const texts = ['Fullstack Developer', 'React & Node.js Engineer', 'UI/UX Enthusiast'];
    let textIndex = 0;
    let charIndex = 0;
      ...
      <div className="container hero-container">
        ...
        <div className="hero-visual">
          ...
          <div className="social-links">
            <a href="https://github.com/IrfanPandu" target="_blank" rel="noreferrer" className="social-link" aria-label="GitHub">
            ...
            <a href="https://www.linkedin.com/in/irfan-pandu-pratama/" target="_blank" rel="noreferrer" className="social-link" aria-label="LinkedIn">
